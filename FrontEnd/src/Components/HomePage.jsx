    ...
    <>
      <nav className="p-4 flex items-center justify-between border-b borde  bg-cyan-800">
        ...
        <div className="mr-10 flex gap-6">
          <button className="border hover:shadow-lg duration-300 py-2 rounded w-28 bg-white">
            Sign In
          </button>
          <button className="border hover:shadow-lg duration-300 py-2 rounded w-28 bg-white">
            Sign UP
      ...
      <div className="flex">
        <aside className="sidebar pl-10 border-r border-cyan-500 p-4 ">
          <ul className="pt-2 pb-4 space-y-1 text-cyan-950 text-sm">
            <li className="">
              <a
                href="#"
              ...
              >
                <svg
                  ...
                  viewBox="0 0 512 512"
                  className="w-5 h-5 fill-current text-cyan-800"
                >
          ...
          <ul className="pt-4 mt-64 pb-2 space-y-1 text-sm">
            <li>
              <a
                href="#"
                className="flex items-center p-2 space-x-3 rounded-md"
        ...
        <div>
          <div className="m-16 posts  overflow-x-auto">
            {userData.map((user, index) => (
              <div key={index} className="m-8 border border-cyan-700 p-10 ">
                <h1 className="font-bold text-2xl border border-cyan-500 py-2 pl-5">{user.username}</h1 >
                <div className="flex items-center gap-10">
                  <div className="my-3 w-3/4 bg-slate-700">
                    <img className="" src={user.link} alt="" />
                  </div>
                  <div className="text-center">
                    <button className=" bg-cyan-700 font-mono text-white rounded py-3 px-9">Like</button>
